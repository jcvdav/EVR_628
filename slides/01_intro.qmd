---
title: "Week 1: Introduction to Data Science and RStudio IDE"
---
...
- When emailing, please include `EVR628` in your subject heading

## Adaptive Approach

- About five weeks in I will poll you (anonymously)
  - Speed things up? Slow things down?
  - Are materials relevant to you?
- Welcome feedback anytime throughout the course
...
- Create [slides with interactive content](https://jcvdav.github.io/EVR_628/slides/11_spat_data_1.html#/example-rosenstiel) for effective communication
- If time llows:
...
- I would add "Collect" before "Import"
...
**RSM 612**
![](img/RSM612.png){.nostretch fig-align="center" width="600"}
...
**MBE 716**
![](img/bayesian_stats.png){.nostretch fig-align="center" width="600"}
...
- If you get really good, even _agentic_ coding
:::
...
::: {.nonincremental}
- Download and install the latest version of R (currently v 4.6.x) for [MacOS](https://cran.r-project.org/bin/macosx/) or [Windows](https://cran.r-project.org/bin/windows/base/)
...
- The TA will moderate the video
...
- [ ] Load packages to make sure they work
:::
:::
