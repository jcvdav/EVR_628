...
- [IDSC Fellowship](https://idsc.miami.edu/apply-now-2026-2027-idsc-fellows/)
- [Viz UM](https://events.miami.edu/event/vizum-2026)
...
Read more [here](https://tidyverse.org/blog/2017/12/workflow-vs-script/)
:::
...
- Formatting presets (feature, not bug)
:::
...
- Today is when we start to learn about data wrangling with two key packages:
  ...
  - `{janitor}` - We will install it on Thursday
...
- `summarize()`: Collapse many values down to a single value (by group)
:::
...
- `dplyr` verbs are organized into groups based on what they operate on: rows, columns, or groups
...
**Example:** All data from sites "a" or "b", after the MPA was established
...
- [Survey](https://forms.gle/z41tkmgeVww9X4TW8)
- Assignment 2 live next week
