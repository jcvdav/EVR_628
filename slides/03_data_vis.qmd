...
- _Variable_: A measurable quality, quantity or property
- _Value_: The state of the variable
- _Observation_: A data point to which variables and values are assigned
...
- _Numerical_: (AKA "quantitative") a measurement expressed in numbers, instead of words
    - Discrete numerical: Counts, integer numbers
    - Continuous numerical: Think decimal numbers
- _Categorical_: (AKA "qualitative") a measurement expressed in words, instead of numbers
- _Ordinal_: A special type of categorical data, where the order of the categories has a meaning
...
What _type_ of data is shown in _variable_ `id`?
...
- scatter plot, column chart (stacked columns, dodge columns), histogram, 2d-histogram, violin plots, box-plots, pie charts (eww), heat maps, line graphs, area charts, stacked area, density, voronoi plots, alluvial diagrams...
...
That _something_ is usually one of 4:
...
You know what _type_ of graph you want, lets make it effective
...
- [ ] If you absolutely need color, consider _type_ of data:
  - [ ] [categorical](#categorical-data): Use a discrete color palette (e.g. `EVR628tools::palette_UM()`)
  - [ ] [ordinal and numeric](#ordinal-or-numeric): single hue with varying saturation or multi-hue _designed_ for sequential (e.g. `viridis` colors)
  - [ ] If ordinal but [diverging](#diverging) data: two contrasting hues and neutral center is better than a single hue or multi-hues
...
Before Thursday: Read [Chapter 1](https://r4ds.hadley.nz/data-visualize.html) of R4DS
...
- Proposed by Leland Wilkinson in '05 @wilkinson2011grammar
...
- Leverages the _layered grammar of graphics_ proposed in @layered-grammar
...
4. Modify `geom`s as needed (optional)
...
My guide for [live coding](https://jcvdav.github.io/EVR_628/docs/03_live.html)
