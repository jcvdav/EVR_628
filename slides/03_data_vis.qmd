...
- If you absolutely need color, consider _type_ of data:
  ...
  - [ordinal and numeric](#ordinal-or-numeric): single hue with varying saturation or multihue _designed_ for sequential (e.g. `viridis` colors)
  - If ordinal but [diverging](#diverging) data: two contrasting hues and neutral center is better than a single hue or multihues
