---
title: "Keeping track of your code with Git and GitHub"
---
...
- Think of the last figure, table, or number you produced for a class or job. If I asked you to regenerate it today with one column of the raw data changed, could you? What exactly would break?
- Why isn't DropBox or GoogleDrive enough?
- Who is reproducibility for?
...
- Portfolio building: Showcase your skills to employers ([tuna data](https://jcvdav.github.io/tuna_data/) by E. Rodriguez)
...
- The folder on my computer called `tuna_data` is the local repo
- What you saw [online](https://github.com/human-ocean/tuna_data) was the remote repo
...
Instructions available [here](https://jcvdav.github.io/EVR_628/docs/02_installing_git.html), and under Week 2 in the course's website
:::
...
- 50%: exists
- 30%: has a `README.md` file with content (name, about you, about the project)
- 10%: has a `.gitignore` file
- 10%: has at least two commits, in addition to the default one
