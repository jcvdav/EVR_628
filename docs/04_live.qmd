...
- Create a data frame called `shark_data` with columns called:
  - `species`: the `shark_species` vector from Exercise 2
  - `length_meters`: the `length_m` vector from Exercise 2
  - `length_feet`: the converted lengths in feet
- Check the dimensions of your data frame using `dim()`
