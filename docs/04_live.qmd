...
3. Load the `EVR628tools` package

3. Inspect the new `?data_MPA`

4. Let's visualize things

5. Create four objects containing:
...
7. Finally, calculate the difference between these two sites
