...
Wikham et al., Welcome to the Tidyverse. CRAN (2019). https://cran.r-project.org/web/packages/tidyverse/vignettes/paper.html
Rudis, Ross, & Garnier. Introduction to the viridis colormaps. CRAN (2024). https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html
...
Englander. “Timeless principles for better figure design”. The World Bank. (2024). https://blogs.worldbank.org/en/impactevaluations/timeless-principles-for-better-figure-design
